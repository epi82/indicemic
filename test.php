...
?>
    ...
    <script type="text/javascript" src="js/test_datagrid.js"></script>
...
<table>
  <tr>
    <td>
      <div align="center">
              <table border="0" cellspacing="0" cellpadding="1" height="26">
                <tr height="26">                       
                  <td height="26">                        
                    <div align="center">
                            <table border="0" cellspacing="0" cellpadding="0" >                        
                              <tr>                        
                                <td>                                    
                                  <div align="center">                                    
                                          <table border="0" cellspacing="2" cellpadding="4" style="border:1px solid #ffffff">                                    
                                            <tr>
                                              <td>
