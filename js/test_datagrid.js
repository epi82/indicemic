    ...
    var tbar = new Ext.Toolbar({
      ...
      var grid = new Ext.grid.GridPanel({
        ...
        columns: [
            ...
            {id:'tossi', header: "Tossicologia", width: 160, sortable: true, renderer: tossi, dataIndex: 'tossi', filter:{ }},                        
            {id:'datains', header: "Aggior.", width: 70, sortable: true, renderer: data, dataIndex: 'datains'}   
        ],
        highlightClasses: {
