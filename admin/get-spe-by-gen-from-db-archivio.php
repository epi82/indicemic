...
sql2json("SELECT id,CONCAT(specie,' ',autore) as speaut FROM archivio WHERE specie LIKE '$query%' AND genere='$gensel' ORDER BY specie,autore",$db_host,$db_user,$db_password,$db_name);
