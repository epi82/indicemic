...
<script type="text/javascript" src="../js/FormModTossi.js"></script>
<script type="text/javascript" src="../js/FormModTossi_Step2.js"></script>
...
<?
  ...
  {
    $query = "SELECT * FROM tossicologia WHERE id=$id_tossi";
...
?>
     ...
     <script type="text/javascript">var tossi_old="<? echo $tossi;?>"</script>
     <script type="text/javascript">var post="<? echo $post;?>"</script>
     <tr class="testo1" height="327">
         <td height="327" valign="top" width="954">
         <br />
            <div align="center">
                <div id="FormModTossi_Step2"></div>
            </div>
        </td>
     </tr>     
<?
